...
const FilePreviewModal = ({ file, onClose }) => {
    ...
    const openInNewTab = () => {
        window.open(fileUrl.replace('preview=true', 'preview=false'), '_blank');
    };
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <span className="text-[10px] font-bold text-slate-300 uppercase underline decoration-primary-blue/30 tracking-widest">Shared for Preview</span>
                            </div>
                        </div>
                    </div>
                    ...
                    {file.mimetype.startsWith('image/') ? (
                        ...
                        <div className="w-full h-full bg-white relative">
                            ...
                            <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity">
                                <button onClick={openInNewTab} className="bg-slate-900/80 text-white p-3 rounded-full hover:bg-slate-900 shadow-xl backdrop-blur-sm">
