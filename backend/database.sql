...
CREATE UNIQUE INDEX IF NOT EXISTS idx_active_sprint_team ON sprints (team_id) WHERE status = 'Active';
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    status VARCHAR(50) DEFAULT 'Backlog' CHECK (status IN ('Backlog', 'To Do', 'In Progress', 'Review', 'Done')),
